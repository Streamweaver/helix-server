...
class DisaggregationViewSet(ListOnlyViewSetMixin):
    ...
    def _export_disaggregated_geojson(self, qs):
        ...
        readme_text = (
            ...
            " "No" otherwise. This field relies on the data specified in "Reported Figures" and is linked to the "Unit""
            ...
            "by either dividing the total figure by the number of locations or distributing the "Total figures" values based"
            ...
            "Information System (GIS) software may interpret these multi-point entities as singular data points, potentially"
            ...
            "DATA DESCRIPTION: 2_Context_Displacement_data table\n"
            "\n"
            "This dataset provides contextual information and analysis documented by IDMC analysts. It captures"
            " flags related to methodology, caveats, sources, and challenges identified for each metric, reporting"
            " year, and country.\n"
            "\n"
            "ISO3: Represents the ISO 3166-1 alpha-3 code, the code 'AB9' is assigned to the Abyei Area.\n"
            "Year: Indicates the year for which displacement data are reported.\n"
            ...
            "Description: Provides contextual information about the data, including sources and data limitations."
            " It is essential for representing the analysis conducted by IDMC analysts. This field also details the"
            " methodology used, descriptions of sources, and outlines any caveats and challenges identified with the"
